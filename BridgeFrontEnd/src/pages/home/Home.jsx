    ...
    <div className="h-screen w-full">
      ...
      <article className="flex flex-col h-auto md:flex-row">
        ...
        <div className="flex flex-col bg-primary p-4 md:justify-center">
          <h3 className="mb-12 md:mb-24 pb-2 text-center text-5xl font-bold text-white">
            Encuentra tu match universitario
          </h3>
          <p className="text-black/90 md:text-2xl">
            Encuentra a tu squad universitario ideal! Nuestra app conecta a
            estudiantes con perfiles diversos para armar equipos de estudio que
            brillen en todas las habilidades. Desde liderazgo hasta creatividad,
            ¡Aquí todos tienen su lugar para triunfar juntos!{" "}
          </p>
        </div>
      </article>
      <footer className="flex flex-col items-center w-full py-4">
        <h2 className="pb-2 text-center font-bold md:text-xl">
