...
export const ProyectoEspecifico = () => {
  ...
  const { data: project, isLoading } = useQuery("projectInformation" + projectId, () => getProject(projectId), queryConfig);
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row">
            <div className='w-auto md:mr-5 self-center'>
              <img src={project.portadaLink} className="max-h-[300px]" alt={project.titulo}/>   
            </div>
