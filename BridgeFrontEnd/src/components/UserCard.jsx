...
export const UserCard = ({ profilePic, name, username, className, extraButton, commonCount}) => {
      ...
      <div className="grow-1">
        ...
        {commonCount && (
          <div className="flex items-center gap-1 text-gray-400 font-light text-sm overflow-hidden">
            <p className="text-gray-400 text-sm">{commonCount} builders en común</p>
          </div>
        )}
      </div>
      {extraButton && (
        <div className="self-left ml-auto p-2">
          {extraButton}
        </div>
      )}      
    </div>
